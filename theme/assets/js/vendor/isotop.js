...
<html dir="ltr" lang="vi"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>file:///C:/Users/admin/Desktop/IoC/assets/js/vendor/isotop.js</title>
...
body {
  ...
  --error-code-color: #A2A3A3;
  --google-blue-100: rgb(210, 227, 252);
  --google-blue-300:#4fba69;
  --google-blue-600:#4fba69;
...
#tor-suggestion:not([hidden]) {
  display: flex;
  flex-direction: column;
  width: 100%;
}

#tor-suggestion > button {
  width: fit-content;
  float: left;
  margin-top: 12px;
  padding: 10px 16px 10px 36px;
  background-image: url('data:image/svg+xml;base64,');
...
function openWithTor() {
  if (window.errorPageController) {
    errorPageController.openWithTorButtonClick();
  }
}
...
function onDocumentLoadOrUpdate() {
  ...
  // Open with Tor button.
  const ableToShowTorSuggestion =
      loadTimeData.valueExists('ableToShowTorSuggestion') &&
      loadTimeData.getValue('ableToShowTorSuggestion');
  const torSuggestion = document.querySelector('div#tor-suggestion');
  const seperator = document.querySelector('div.sep');
  torSuggestion.hidden =
      !ableToShowTorSuggestion || offlineContentVisible||
...
function hideCocCocTorOption() {
  const torSuggestion = document.querySelector('div#tor-suggestion');
  const seperator = document.querySelector('div.sep');
  if (torSuggestion && seperator) {
    torSuggestion.hidden = true;
...
<body id="t" class="neterror" style="font-family: &#39;Segoe UI&#39;, Tahoma, sans-serif; font-size: 75%" jstcache="0">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        <h1 jstcache="0">
          <span jsselect="heading" jsvalues=".innerHTML:msg" jstcache="9">Không thể truy cập vào tệp của bạn</span>
          <a id="error-information-button" class="hidden" onclick="toggleErrorInformationPopup();" jstcache="0"></a>
        </h1>
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1">Tệp này có thể đã bị di chuyển, chỉnh sửa hoặc xóa.</p>
          ...
          <div id="error-information-popup" jstcache="0">
            <div id="error-information-popup-box" jstcache="0">
              <div id="error-information-popup-content" jstcache="0">
                ...
                <div class="suggest-block" jstcache="0">
                  <div id="suggestions-list" style="display:none" jsdisplay="(suggestionsSummaryList &amp;&amp; suggestionsSummaryList.length)" jstcache="18">
                    <ul jsvalues=".className:suggestionsSummaryList.length == 1 ? &#39;single-suggestion&#39; : &#39;&#39;" jstcache="20">
                      <li jsselect="suggestionsSummaryList" jsvalues=".innerHTML:summary" jstcache="24"></li>
                    </ul>
                  </div>
                  <div class="sep" hidden="" jstcache="0"></div>
                  <div id="tor-suggestion" hidden="" jstcache="0">
                    <div class="suggestion-title" jscontent="torTitleText" jstcache="21">null</div>
                    <div class="suggestion-desc" jsvalues=".innerHTML:torDescriptionText" jstcache="22"></div>
                    <button class="open-tor-tab" onclick="openWithTor();" jscontent="torRetryWithTorButtonText" jstcache="23">null</button>
                  </div>
                </div>
                <div class="error-code" jscontent="errorCode" jstcache="17">ERR_FILE_NOT_FOUND</div>
                <p id="error-information-popup-close" jstcache="0">
                  <a class="link-button" jscontent="closeDescriptionPopup" onclick="toggleErrorInformationPopup();" jstcache="19">null</a>
                </p>
              </div>
            </div>
          </div>
  ...
  <div id="sub-frame-error" jstcache="0">
    ...
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="1">Tệp này có thể đã bị di chuyển, chỉnh sửa hoặc xóa.</div>
  </div>
