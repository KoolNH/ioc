                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-12">
                                                        <div class="rbt-card variation-01 rbt-hover">
                                                            ...
                                                            <div class="rbt-card-body">
                                                                ...
                                                                <?php if ($course['is_hidden']): ?>
                                                                    <small class="text-danger">Hidden</small>
                                                                    <form method="post" action="./show-course.php?id=<?php echo $course['id'] ?>" class="d-inline">
                                                                        <button class="btn btn-success btn-lg" onclick="return confirm('Are you sure?');"> Show </button>
                                                                    </form> 
                                                                <?php else: ?>
                                                                    <form method="post" action="./hide-course.php?id=<?php echo $course['id'] ?>" class="d-inline">
                                                                        <button class="btn btn-danger btn-lg" onclick="return confirm('Are you sure?');"> Hide </button>
                                                                    </form>   
                                                                <?php endif; ?>
