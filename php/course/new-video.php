...
if (!empty($_POST)) {
    ...
    if (count($errors) == 0) {
        ...
        // insert user into db
        $sql = "INSERT INTO `videos` (`id`, `title`, `url`, `topic_id`, duration_in_minute) VALUES (NULL, '$title', '$url', '$topic_id', '$duration_in_minute');";
        $result = $conn->query($sql);

        // redirect to /my courses
        header("Location: /course/edit-course.php?id={$topic['course_id']}&message=Added successfully!");
    }
